...
// ============================================================================
// ExerciseLoader Implementation
// ============================================================================

ExerciseLoader::ExerciseLoader(std::shared_ptr<Database> database) : db(database) {
}

std::vector<std::string> ExerciseLoader::parseJsonArray(const std::string& jsonStr) const {
...
bool ExerciseLoader::parseExerciseFromRow(PGresult* result, int row, Exercise& exercise) const {
    try {
...
Exercise ExerciseLoader::loadExerciseById(int exerciseId) {
    Exercise exercise;
...
ExerciseList ExerciseLoader::loadExercisesByFilter(const std::string& type, const std::string& level, int lessonId) {
    ExerciseList exerciseList;
