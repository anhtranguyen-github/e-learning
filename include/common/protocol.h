...
enum class MsgCode : uint16_t {
    ...
    // Exercise management
    EXERCISE_LIST_REQUEST = 170,
    EXERCISE_LIST_SUCCESS = 171,
    EXERCISE_LIST_FAILURE = 173,

    STUDY_EXERCISE_REQUEST = 180,
    STUDY_EXERCISE_SUCCESS = 181,
    STUDY_EXERCISE_FAILURE = 183,

    // Notifications
    NOTIFICATION_PUSH = 190,

    RESULT_LIST_REQUEST = 200,
    SUBMIT_ANSWER_REQUEST = 210,
