...
enum class MsgCode : uint16_t {
    ...
    SUBMISSION_DETAIL_REQUEST = 280,
    SUBMISSION_DETAIL_SUCCESS = 281,
    SUBMISSION_DETAIL_FAILURE = 282,
    ...
    GAME_CREATE_REQUEST = 390,
    GAME_CREATE_SUCCESS = 391,
    GAME_CREATE_FAILURE = 392,

    GAME_DELETE_REQUEST = 393,
    GAME_DELETE_SUCCESS = 394,
    GAME_DELETE_FAILURE = 395,

    GAME_UPDATE_REQUEST = 396,
    GAME_UPDATE_SUCCESS = 397,
    GAME_UPDATE_FAILURE = 398,
